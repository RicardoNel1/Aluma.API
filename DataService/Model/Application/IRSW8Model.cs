...
namespace DataService.Model
{
    ...
    public class IRSW8Model : BaseModel
    {
        ...
        public ICollection<USPersonsModel> USPersons { get; set; }
    ...
    public class IRSW8ModelBuilder : IEntityTypeConfiguration<IRSW8Model>
    {
        public void Configure(EntityTypeBuilder<IRSW8Model> mb)
        {
            mb.HasMany(c => c.USPersons)
                .WithOne(c => c.IRSW8)
                .HasForeignKey(c => c.IRSW8Id)
                .IsRequired()
