...
namespace DataService.Migrations
{
    ...
    [Migration("20220613101125_AssetSummaryModel")]
    partial class AssetSummaryModel
    {
            ...
            modelBuilder.Entity("DataService.Model.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 78, DateTimeKind.Local).AddTicks(5413),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 78, DateTimeKind.Local).AddTicks(5432),
                            ModifiedBy = 0,
                            PostalCode = "0081",
                        ...
                        new
                        {
                            ...
                            Country = "South Africa",
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 78, DateTimeKind.Local).AddTicks(8387),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 78, DateTimeKind.Local).AddTicks(8392),
                            ModifiedBy = 0,
                            PostalCode = "2157",
            ...
            modelBuilder.Entity("DataService.Model.AdvisorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdviceWarrants = true,
                            AppointmentDate = new DateTime(2021, 6, 13, 12, 11, 24, 45, DateTimeKind.Local).AddTicks(1593),
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 44, DateTimeKind.Local).AddTicks(3717),
                            CreatedBy = 0,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 45, DateTimeKind.Local).AddTicks(772),
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("DataService.Model.ProductModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(5239),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(5250),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 2,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7548),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7553),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 3,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7559),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7560),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 4,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7563),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7564),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 5,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7566),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7567),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 6,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7578),
                            CreatedBy = 0,
                            Description = "Limited partner interests (the 'Interests') in The Aluma Capital Private Equity Fund I Partnership (the 'Partnership') are being offered to qualified investors.\r\n                                The Interests are offered subject to the right of Aluma Capital General Partner(Proprietary) Limited(the 'General Partner'), in its capacity as the ultimate\r\n                                general partner of the Partnership, to reject any application in whole or in part.",
                            Institute = "Aluma Capital",
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7579),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 7,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7582),
                            CreatedBy = 0,
                            Description = " ",
                            Institute = "Vanguard",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 52, DateTimeKind.Local).AddTicks(7583),
                            ModifiedBy = 0,
                            Name = "Fixed Income",
                            PaymentType = 0,
                            ProductCategory = 1,
            ...
            modelBuilder.Entity("DataService.Model.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 6, 13, 12, 11, 24, 66, DateTimeKind.Local).AddTicks(2034),
                            CreatedBy = 0,
                            Email = "dev@aluma.co.za",
                            FirstName = "Dev",
                            LastName = "Tester",
                            MobileNumber = "0843334444",
                            Modified = new DateTime(2022, 6, 13, 12, 11, 24, 66, DateTimeKind.Local).AddTicks(2048),
                            ModifiedBy = 0,
                            Password = "9647.4a7XvlAlT8YUawy6GgCDew==.calKY6UfB72jcIJom6iT5j6M0xDlnv5/5YEUjr/OQyA=",
