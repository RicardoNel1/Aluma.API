...
namespace DataService.Migrations
{
    ...
    [Migration("20220609130241_RemoveFierdOnEconomy")]
    partial class RemoveFierdOnEconomy
    {
            ...
            modelBuilder.Entity("DataService.Model.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 432, DateTimeKind.Local).AddTicks(3115),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 432, DateTimeKind.Local).AddTicks(3130),
                            ModifiedBy = 0,
                            PostalCode = "0081",
                        ...
                        new
                        {
                            ...
                            Country = "South Africa",
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 432, DateTimeKind.Local).AddTicks(5842),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 432, DateTimeKind.Local).AddTicks(5846),
                            ModifiedBy = 0,
                            PostalCode = "2157",
            ...
            modelBuilder.Entity("DataService.Model.AdvisorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdviceWarrants = true,
                            AppointmentDate = new DateTime(2021, 6, 9, 15, 2, 40, 400, DateTimeKind.Local).AddTicks(3282),
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 399, DateTimeKind.Local).AddTicks(6370),
                            CreatedBy = 0,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 400, DateTimeKind.Local).AddTicks(2499),
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("DataService.Model.ProductModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 406, DateTimeKind.Local).AddTicks(8023),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 406, DateTimeKind.Local).AddTicks(8034),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 2,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(348),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(352),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 3,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(358),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(359),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 4,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(362),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(363),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 5,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(365),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(366),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 6,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(371),
                            CreatedBy = 0,
                            Description = "Limited partner interests (the 'Interests') in The Aluma Capital Private Equity Fund I Partnership (the 'Partnership') are being offered to qualified investors.\r\n                                The Interests are offered subject to the right of Aluma Capital General Partner(Proprietary) Limited(the 'General Partner'), in its capacity as the ultimate\r\n                                general partner of the Partnership, to reject any application in whole or in part.",
                            Institute = "Aluma Capital",
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(372),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 7,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(374),
                            CreatedBy = 0,
                            Description = " ",
                            Institute = "Vanguard",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 407, DateTimeKind.Local).AddTicks(375),
                            ModifiedBy = 0,
                            Name = "Fixed Income",
                            PaymentType = 0,
                            ProductCategory = 1,
            ...
            modelBuilder.Entity("DataService.Model.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 6, 9, 15, 2, 40, 420, DateTimeKind.Local).AddTicks(6457),
                            CreatedBy = 0,
                            Email = "dev@aluma.co.za",
                            FirstName = "Dev",
                            LastName = "Tester",
                            MobileNumber = "0843334444",
                            Modified = new DateTime(2022, 6, 9, 15, 2, 40, 420, DateTimeKind.Local).AddTicks(6473),
                            ModifiedBy = 0,
                            Password = "9557.CYCz4MuxvYRl2zJtinbWIA==.mdBbz+rnZd01xTGYS21gZREJRt8wGIf28Lq7qKUZobQ=",
