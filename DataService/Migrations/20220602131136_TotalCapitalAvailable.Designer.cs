...
namespace DataService.Migrations
{
    ...
    [Migration("20220602131136_TotalCapitalAvailable")]
    partial class TotalCapitalAvailable
    {
            ...
            modelBuilder.Entity("DataService.Model.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 274, DateTimeKind.Local).AddTicks(2325),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 274, DateTimeKind.Local).AddTicks(2345),
                            ModifiedBy = 0,
                            PostalCode = "0081",
                        ...
                        new
                        {
                            ...
                            Country = "South Africa",
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 274, DateTimeKind.Local).AddTicks(5571),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 274, DateTimeKind.Local).AddTicks(5575),
                            ModifiedBy = 0,
                            PostalCode = "2157",
            ...
            modelBuilder.Entity("DataService.Model.AdvisorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdviceWarrants = true,
                            AppointmentDate = new DateTime(2021, 6, 2, 15, 11, 35, 242, DateTimeKind.Local).AddTicks(9458),
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 242, DateTimeKind.Local).AddTicks(2590),
                            CreatedBy = 0,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 242, DateTimeKind.Local).AddTicks(8569),
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("DataService.Model.ProductModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(4045),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(4066),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 2,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6215),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6223),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 3,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6229),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6230),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 4,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6233),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6234),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 5,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6236),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6237),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 6,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6243),
                            CreatedBy = 0,
                            Description = "Limited partner interests (the 'Interests') in The Aluma Capital Private Equity Fund I Partnership (the 'Partnership') are being offered to qualified investors.\r\n                                The Interests are offered subject to the right of Aluma Capital General Partner(Proprietary) Limited(the 'General Partner'), in its capacity as the ultimate\r\n                                general partner of the Partnership, to reject any application in whole or in part.",
                            Institute = "Aluma Capital",
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6244),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 7,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6246),
                            CreatedBy = 0,
                            Description = " ",
                            Institute = "Vanguard",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 250, DateTimeKind.Local).AddTicks(6247),
                            ModifiedBy = 0,
                            Name = "Fixed Income",
                            PaymentType = 0,
                            ProductCategory = 1,
            ...
            modelBuilder.Entity("DataService.Model.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 6, 2, 15, 11, 35, 263, DateTimeKind.Local).AddTicks(9768),
                            CreatedBy = 0,
                            Email = "dev@aluma.co.za",
                            FirstName = "Dev",
                            LastName = "Tester",
                            MobileNumber = "0843334444",
                            Modified = new DateTime(2022, 6, 2, 15, 11, 35, 263, DateTimeKind.Local).AddTicks(9786),
                            ModifiedBy = 0,
                            Password = "9224.Fc7Xu8cQQQNQJIbf1Bnj6w==.RViv7t/h2KG1P735n4iZgd/9q92rfZOaCgy02jTpEM4=",
