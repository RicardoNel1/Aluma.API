...
namespace DataService.Migrations
{
    ...
    [Migration("20220603210627_FixTypoAssumptionsDTO")]
    partial class FixTypoAssumptionsDTO
    {
            ...
            modelBuilder.Entity("DataService.Model.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 338, DateTimeKind.Local).AddTicks(4361),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 338, DateTimeKind.Local).AddTicks(4379),
                            ModifiedBy = 0,
                            PostalCode = "0081",
                        ...
                        new
                        {
                            ...
                            Country = "South Africa",
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 338, DateTimeKind.Local).AddTicks(6855),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 338, DateTimeKind.Local).AddTicks(6859),
                            ModifiedBy = 0,
                            PostalCode = "2157",
            ...
            modelBuilder.Entity("DataService.Model.AdvisorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdviceWarrants = true,
                            AppointmentDate = new DateTime(2021, 6, 3, 23, 6, 26, 308, DateTimeKind.Local).AddTicks(9837),
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 308, DateTimeKind.Local).AddTicks(3346),
                            CreatedBy = 0,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 308, DateTimeKind.Local).AddTicks(9123),
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("DataService.Model.ProductModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(1459),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(1471),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 2,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3454),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3459),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 3,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3464),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3465),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 4,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3467),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3468),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 5,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3471),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3471),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 6,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3476),
                            CreatedBy = 0,
                            Description = "Limited partner interests (the 'Interests') in The Aluma Capital Private Equity Fund I Partnership (the 'Partnership') are being offered to qualified investors.\r\n                                The Interests are offered subject to the right of Aluma Capital General Partner(Proprietary) Limited(the 'General Partner'), in its capacity as the ultimate\r\n                                general partner of the Partnership, to reject any application in whole or in part.",
                            Institute = "Aluma Capital",
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3476),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 7,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3479),
                            CreatedBy = 0,
                            Description = " ",
                            Institute = "Vanguard",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 315, DateTimeKind.Local).AddTicks(3479),
                            ModifiedBy = 0,
                            Name = "Fixed Income",
                            PaymentType = 0,
                            ProductCategory = 1,
            ...
            modelBuilder.Entity("DataService.Model.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 6, 3, 23, 6, 26, 327, DateTimeKind.Local).AddTicks(7228),
                            CreatedBy = 0,
                            Email = "dev@aluma.co.za",
                            FirstName = "Dev",
                            LastName = "Tester",
                            MobileNumber = "0843334444",
                            Modified = new DateTime(2022, 6, 3, 23, 6, 26, 327, DateTimeKind.Local).AddTicks(7249),
                            ModifiedBy = 0,
                            Password = "9615.wxS0yyrSGZStXlRXVxUjQg==.rwGVxmBvWMF1J+VqgvvWKU3zNjzRoHZ+qnEx391/Lrs=",
