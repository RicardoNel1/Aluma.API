...
namespace DataService.Migrations
{
    ...
    [Migration("20220615120338_RecordOfAdviceFieldsLength")]
    partial class RecordOfAdviceFieldsLength
    {
            ...
            modelBuilder.Entity("DataService.Model.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 60, DateTimeKind.Local).AddTicks(8413),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 60, DateTimeKind.Local).AddTicks(8459),
                            ModifiedBy = 0,
                            PostalCode = "0081",
                        ...
                        new
                        {
                            ...
                            Country = "South Africa",
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 61, DateTimeKind.Local).AddTicks(3409),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 61, DateTimeKind.Local).AddTicks(3424),
                            ModifiedBy = 0,
                            PostalCode = "2157",
            ...
            modelBuilder.Entity("DataService.Model.AdvisorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdviceWarrants = true,
                            AppointmentDate = new DateTime(2021, 6, 15, 14, 3, 35, 982, DateTimeKind.Local).AddTicks(9654),
                            Created = new DateTime(2022, 6, 15, 14, 3, 35, 981, DateTimeKind.Local).AddTicks(3851),
                            CreatedBy = 0,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 35, 982, DateTimeKind.Local).AddTicks(8187),
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("DataService.Model.ProductModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 4, DateTimeKind.Local).AddTicks(8554),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 4, DateTimeKind.Local).AddTicks(8605),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 2,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2470),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2484),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 3,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2494),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2495),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 4,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2499),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2501),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 5,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2505),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2506),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 6,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2520),
                            CreatedBy = 0,
                            Description = "Limited partner interests (the 'Interests') in The Aluma Capital Private Equity Fund I Partnership (the 'Partnership') are being offered to qualified investors.\r\n                                The Interests are offered subject to the right of Aluma Capital General Partner(Proprietary) Limited(the 'General Partner'), in its capacity as the ultimate\r\n                                general partner of the Partnership, to reject any application in whole or in part.",
                            Institute = "Aluma Capital",
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2521),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 7,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2525),
                            CreatedBy = 0,
                            Description = " ",
                            Institute = "Vanguard",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 5, DateTimeKind.Local).AddTicks(2526),
                            ModifiedBy = 0,
                            Name = "Fixed Income",
                            PaymentType = 0,
                            ProductCategory = 1,
            ...
            modelBuilder.Entity("DataService.Model.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 6, 15, 14, 3, 36, 37, DateTimeKind.Local).AddTicks(7821),
                            CreatedBy = 0,
                            Email = "dev@aluma.co.za",
                            FirstName = "Dev",
                            LastName = "Tester",
                            MobileNumber = "0843334444",
                            Modified = new DateTime(2022, 6, 15, 14, 3, 36, 37, DateTimeKind.Local).AddTicks(7885),
                            ModifiedBy = 0,
                            Password = "9956.p/5zBqO3n1ozkx05YVjUhw==.F+Pk5enn/JP3em0qIRHXDJ+xfXiuju1RM0GLblxfx2M=",
