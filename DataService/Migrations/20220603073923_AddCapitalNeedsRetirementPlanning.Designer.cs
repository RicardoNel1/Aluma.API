...
namespace DataService.Migrations
{
    ...
    [Migration("20220603073923_AddCapitalNeedsRetirementPlanning")]
    partial class AddCapitalNeedsRetirementPlanning
    {
            ...
            modelBuilder.Entity("DataService.Model.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 694, DateTimeKind.Local).AddTicks(8073),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 694, DateTimeKind.Local).AddTicks(8091),
                            ModifiedBy = 0,
                            PostalCode = "0081",
                        ...
                        new
                        {
                            ...
                            Country = "South Africa",
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 695, DateTimeKind.Local).AddTicks(627),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 695, DateTimeKind.Local).AddTicks(631),
                            ModifiedBy = 0,
                            PostalCode = "2157",
            ...
            modelBuilder.Entity("DataService.Model.AdvisorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdviceWarrants = true,
                            AppointmentDate = new DateTime(2021, 6, 3, 9, 39, 22, 664, DateTimeKind.Local).AddTicks(283),
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 663, DateTimeKind.Local).AddTicks(3189),
                            CreatedBy = 0,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 663, DateTimeKind.Local).AddTicks(9199),
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("DataService.Model.ProductModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(3250),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(3267),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 2,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5254),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5259),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 3,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5264),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5264),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 4,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5267),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5268),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 5,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5270),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5271),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 6,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5276),
                            CreatedBy = 0,
                            Description = "Limited partner interests (the 'Interests') in The Aluma Capital Private Equity Fund I Partnership (the 'Partnership') are being offered to qualified investors.\r\n                                The Interests are offered subject to the right of Aluma Capital General Partner(Proprietary) Limited(the 'General Partner'), in its capacity as the ultimate\r\n                                general partner of the Partnership, to reject any application in whole or in part.",
                            Institute = "Aluma Capital",
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5277),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 7,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5279),
                            CreatedBy = 0,
                            Description = " ",
                            Institute = "Vanguard",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 670, DateTimeKind.Local).AddTicks(5280),
                            ModifiedBy = 0,
                            Name = "Fixed Income",
                            PaymentType = 0,
                            ProductCategory = 1,
            ...
            modelBuilder.Entity("DataService.Model.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 6, 3, 9, 39, 22, 683, DateTimeKind.Local).AddTicks(3024),
                            CreatedBy = 0,
                            Email = "dev@aluma.co.za",
                            FirstName = "Dev",
                            LastName = "Tester",
                            MobileNumber = "0843334444",
                            Modified = new DateTime(2022, 6, 3, 9, 39, 22, 683, DateTimeKind.Local).AddTicks(3044),
                            ModifiedBy = 0,
                            Password = "9996.S54BcCjWVSsWH+oysCO2MA==.eUd6sJk9RaiL0RSuB9SBY+iES8mVxee0PZr/BcOX7LY=",
