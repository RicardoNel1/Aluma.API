...
namespace DataService.Migrations
{
    ...
    [Migration("20220621073003_RenamedShortTermInsurance")]
    partial class RenamedShortTermInsurance
    {
            ...
            modelBuilder.Entity("DataService.Model.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 947, DateTimeKind.Local).AddTicks(9370),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 947, DateTimeKind.Local).AddTicks(9377),
                            ModifiedBy = 0,
                            PostalCode = "0081",
                        ...
                        new
                        {
                            ...
                            Country = "South Africa",
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 948, DateTimeKind.Local).AddTicks(1888),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 948, DateTimeKind.Local).AddTicks(1892),
                            ModifiedBy = 0,
                            PostalCode = "2157",
            ...
            modelBuilder.Entity("DataService.Model.AdvisorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdviceWarrants = true,
                            AppointmentDate = new DateTime(2021, 6, 21, 9, 30, 2, 919, DateTimeKind.Local).AddTicks(4599),
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 918, DateTimeKind.Local).AddTicks(8016),
                            CreatedBy = 0,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 919, DateTimeKind.Local).AddTicks(3775),
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("DataService.Model.ProductModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(4981),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(4988),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 2,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6881),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6886),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 3,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6891),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6892),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 4,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6895),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6895),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 5,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6898),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6898),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 6,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6908),
                            CreatedBy = 0,
                            Description = "Limited partner interests (the 'Interests') in The Aluma Capital Private Equity Fund I Partnership (the 'Partnership') are being offered to qualified investors.\r\n                                The Interests are offered subject to the right of Aluma Capital General Partner(Proprietary) Limited(the 'General Partner'), in its capacity as the ultimate\r\n                                general partner of the Partnership, to reject any application in whole or in part.",
                            Institute = "Aluma Capital",
                            IsActive = true,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6909),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 7,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6912),
                            CreatedBy = 0,
                            Description = " ",
                            Institute = "Vanguard",
                            IsActive = false,
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 925, DateTimeKind.Local).AddTicks(6912),
                            ModifiedBy = 0,
                            Name = "Fixed Income",
                            PaymentType = 0,
                            ProductCategory = 1,
            ...
            modelBuilder.Entity("DataService.Model.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 6, 21, 9, 30, 2, 937, DateTimeKind.Local).AddTicks(9400),
                            CreatedBy = 0,
                            Email = "dev@aluma.co.za",
                            FirstName = "Dev",
                            LastName = "Tester",
                            MobileNumber = "0843334444",
                            Modified = new DateTime(2022, 6, 21, 9, 30, 2, 937, DateTimeKind.Local).AddTicks(9410),
                            ModifiedBy = 0,
                            Password = "9965.bHX6GFz/x96WsEMUeVGKPQ==.afzcB/Bo722k94lD26ewJB6QblaA/FcyjttY+LeX+SI=",
