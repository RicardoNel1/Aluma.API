...
namespace DataService.Migrations
{
    ...
    [Migration("20220525144028_RenameCapitalGainsTax")]
    partial class RenameCapitalGainsTax
    {
            ...
            modelBuilder.Entity("DataService.Model.AddressModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 830, DateTimeKind.Local).AddTicks(4004),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 830, DateTimeKind.Local).AddTicks(4069),
                            ModifiedBy = 0,
                            PostalCode = "0081",
                        ...
                        new
                        {
                            ...
                            Country = "South Africa",
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 831, DateTimeKind.Local).AddTicks(163),
                            CreatedBy = 0,
                            InCareAddress = false,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 831, DateTimeKind.Local).AddTicks(179),
                            ModifiedBy = 0,
                            PostalCode = "2157",
            ...
            modelBuilder.Entity("DataService.Model.AdvisorModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AdviceWarrants = true,
                            AppointmentDate = new DateTime(2021, 5, 25, 16, 40, 25, 760, DateTimeKind.Local).AddTicks(6844),
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 759, DateTimeKind.Local).AddTicks(484),
                            CreatedBy = 0,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 760, DateTimeKind.Local).AddTicks(4731),
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("DataService.Model.AssetsExemptFromCGTModel", b =>
                {
                    ...
                    b.ToTable("fna_assets_exempt_from_cgt");
                });
            ...
            modelBuilder.Entity("DataService.Model.AssumptionsModel", b =>
                {
                    ...
                    b.Property<double>("RetirementAge")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("DataService.Model.ProductModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 779, DateTimeKind.Local).AddTicks(9331),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 779, DateTimeKind.Local).AddTicks(9414),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 2,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4481),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4491),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 3,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4501),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4503),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 4,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4509),
                            CreatedBy = 0,
                            ...
                            Institute = "Standard Bank",
                            IsActive = false,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4510),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 5,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4516),
                            CreatedBy = 0,
                            ...
                            IsActive = true,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4517),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 6,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4575),
                            CreatedBy = 0,
                            Description = "Limited partner interests (the 'Interests') in The Aluma Capital Private Equity Fund I Partnership (the 'Partnership') are being offered to qualified investors.\r\n                                The Interests are offered subject to the right of Aluma Capital General Partner(Proprietary) Limited(the 'General Partner'), in its capacity as the ultimate\r\n                                general partner of the Partnership, to reject any application in whole or in part.",
                            Institute = "Aluma Capital",
                            IsActive = true,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4577),
                            ModifiedBy = 0,
                        ...
                        new
                        {
                            Id = 7,
                            AssociatedRisk = 3,
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4587),
                            CreatedBy = 0,
                            Description = " ",
                            Institute = "Vanguard",
                            IsActive = false,
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 780, DateTimeKind.Local).AddTicks(4588),
                            ModifiedBy = 0,
                            Name = "Fixed Income",
                            PaymentType = 0,
                            ProductCategory = 1,
            ...
            modelBuilder.Entity("DataService.Model.ProvidingOnDreadDiseaseModel", b =>
                {
                    ...
                    b.Property<double>("Needs_GrossAnnualSalary")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("DataService.Model.UserModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 5, 25, 16, 40, 25, 808, DateTimeKind.Local).AddTicks(6436),
                            CreatedBy = 0,
                            Email = "dev@aluma.co.za",
                            FirstName = "Dev",
                            LastName = "Tester",
                            MobileNumber = "0843334444",
                            Modified = new DateTime(2022, 5, 25, 16, 40, 25, 808, DateTimeKind.Local).AddTicks(6486),
                            ModifiedBy = 0,
                            Password = "9454.2ANADFJ2vtJxQqC/5IzK+g==.Z1HztcmARudhTjjC4FDUDrZmSXLlS+LafV2YHMSAhvc=",
