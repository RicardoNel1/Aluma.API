...
{
    public interface IProvidingDeathSummaryRepo : IRepoBase<LiabilitiesModel>
    {
    ...
    public class ProvidingDeathSummaryRepo : RepoBase<LiabilitiesModel>, IProvidingDeathSummaryRepo
    {
